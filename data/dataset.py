...
class MyDataset(Dataset):
    ...
    def _load_meta(self, meta):
        ...
        meta["item_info_list"] = [self.item_processor.extract_quick_info(_) for _ in annotations]
    ...
    def _get_cache_dir(config_path):
        ...
        cache_dir = f"./lumina_data_cache/{config_identifier}"
        return cache_dir
    ...
    def get_item_func(self, meta_idx, idx_in_meta):
        ...
        return self.item_processor.process_item(data_item, self.meta_collection[meta_idx], training_mode=True)
    ...
    def __getitem__(self, index):
        ...
        try:
            return index, self.get_item_func(meta_idx, idx_in_meta)
